		...
		<tr valign="top">
			...
			<td>
				...
				<span class="mcal_event_metabox_time_inputs  <?php if(is_all_day()) {echo '_is_hidden';}; ?>">
					@ <input style="max-width:4rem;" type="number" name="mcal_start_hh" value="<?php echo get_start_date('H'); ?>" placeholder="19" autocomplete="off"> 
					: <input style="max-width:4rem;" type="number" name="mcal_start_mm" value="<?php echo get_start_date('i'); ?>" placeholder="00" autocomplete="off">
				</span>
			</td>
		</tr>
		<tr valign="top">
			...
			<td>
				...
				<span class="mcal_event_metabox_time_inputs <?php if(is_all_day()) {echo '_is_hidden';}; ?>">
					@ <input style="max-width:4rem;" type="number" name="mcal_end_hh" value="<?php echo get_end_date('H');  ?>" placeholder="19" autocomplete="off">
					: <input style="max-width:4rem;" type="number" name="mcal_end_mm" value="<?php echo get_end_date('i');  ?>" placeholder="00" autocomplete="off">
				</span>
			</td>
		</tr>
